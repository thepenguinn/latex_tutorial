...
\begin{frame}[fragile]{Bold, Italics, and more...}
...
\begin{frame}[fragile]{Bold, Italics, and more... (continued)}
...
\begin{frame}[fragile]{Quotes}
    ...
    \alert{'} and \alert{"} corresponds to the closing quotes. For the opening quotes you need to use
    the grave sign ( \alert{$\grave{}$} ).
